package cases.test.automationexercise.pages;

import cases.test.automationexercise.utility.Utility;
...
public class ProductsPage extends Utility {
    ...
    WebElement secondViewProductButton;
